...
public class ControllerCallOfTaxi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           CallOfTaxi objTaxi = new CallOfTaxi(nome, email, login,senha, confSenha, dddCelular, dddTelefone, celular, telefone, estado, cidade, bairro, logradouro, complemento);
