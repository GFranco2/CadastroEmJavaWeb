...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title> View cadastro de usuário</title>
    </head>
    
        <h1>view Call of Taxi</h1>
        ...
        Complemento: <%=((CallOfTaxi) request.getAttribute("usuario")).getComplemento()%><br>
        <a href="view/listaUsuario.jsp">Lista Usuários</a>
